    ...
    <body>
        <section class="session-exp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p><i class="fa fa-warning" aria-hidden="true"></i></p>
                        <h1>Something went wrong!</h1>
                        <h3>Please click below link to redirect to the previous page.</h3>
                        <a class="btn-default" href="javascript:history.back()">Go Back</a>
                    </div>
                </div>
            </div>
        </section>
