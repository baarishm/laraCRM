...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $timesheet->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Timesheets", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/timesheets/'.$timesheet->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Timesheets", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.timesheets.destroy', $timesheet->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/timesheets') }}" data-toggle="tooltip" data-placement="right" title="Back to Timesheets"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'submitor_id')
						@la_display($module, 'project_id')
						@la_display($module, 'task_id')
						@la_display($module, 'date')
						@la_display($module, 'hours')
						@la_display($module, 'minutes')
						@la_display($module, 'comments')
						@la_display($module, 'dependency')
						@la_display($module, 'dependency_for')
						@la_display($module, 'dependent_on')
