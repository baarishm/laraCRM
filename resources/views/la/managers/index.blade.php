...
@section("headerElems")
@la_access("Managers", "create")
	<!--<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Manager</button>-->
@endla_access
@endsection
...
$(function () {
	$("#example1").DataTable({
        ...
        serverSide: true,
        searching : false,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/manager_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
