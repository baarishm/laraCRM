...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $task_role->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Task_Roles", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/task_roles/'.$task_role->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Task_Roles", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.task_roles.destroy', $task_role->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/task_roles') }}" data-toggle="tooltip" data-placement="right" title="Back to Task Roles"><i class="fa fa-chevron-left"></i></a></li>
