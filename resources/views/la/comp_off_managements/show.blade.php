...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $comp_off_management->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Comp_Off_Managements", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/comp_off_managements/'.$comp_off_management->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Comp_Off_Managements", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.comp_off_managements.destroy', $comp_off_management->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/comp_off_managements') }}" data-toggle="tooltip" data-placement="right" title="Back to Comp Off Managements"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'approved')
						@la_display($module, 'approved_by')
						@la_display($module, 'rejected_by')
					</div>
				</div>
			</div>
		</div>
