    ...
    public function dtajax() {
        ...
        for ($i = 0; $i < count($data->data); $i++) {
            ...
            if ($this->show_action) {
                ...
                if (Module::hasAccess("Roles", "delete")) {
                    $output .= Form::open(['route' => [config('laraadmin.adminRoute') . '.roles.destroy', $data->data[$i][0]], 'method' => 'delete', 'style' => 'display:inline', 'class' => 'delete']);
