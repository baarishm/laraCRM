...
class CreateHolidaysListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Holidays_lists", 'holidays_lists', 'occasion', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('holidays_lists')) {
            Schema::drop('holidays_lists');
        }
    }
}
