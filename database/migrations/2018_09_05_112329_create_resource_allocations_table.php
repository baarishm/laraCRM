...
class CreateResourceAllocationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Resource_allocations", 'resource_allocations', 'project_id', 'fa-group', [
            ["project_id", "Project Name", "Dropdown", false, "0", 0, 0, true, "@projects"],
            ["employee_id", "Employee Name", "Dropdown", false, "0", 0, 0, true, "@employees"],
            ["start_date", "From", "Date", false, "", 0, 0, true],
            ["end_date", "To", "Date", false, "", 0, 0, true],
            ["allocation", "Allocation", "Integer", false, "0", 5, 100, true],
        ]);
    ...
    public function down()
    {
        if (Schema::hasTable('resource_allocations')) {
            Schema::drop('resource_allocations');
        }
    }
}
